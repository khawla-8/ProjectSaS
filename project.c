...
void trierParNom() {
    for (int i = 0; i < nb_reservations - 1; i++) {
        for (int j = i + 1; j < nb_reservations; j++) {
...
void afficherStatistiques() {
    ...
    float moyenne_age = nb_reservations > 0 ? total_age / (float)nb_reservations : 0;
     ...
     do{
        ...
        switch (choix) {
            case 1: ajouterReservation();
             break;
            case 2: modifierReservation();
             break;
            case 3: supprimerReservation();
             break;
            case 4: afficherReservation();
             break;
            case 5: trierParNom();
             break;
            case 6: trierreservationsparstatut();
             break;
            case 7: rechercherReservation();
             break;
